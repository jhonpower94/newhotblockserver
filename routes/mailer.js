...
router.route("/").post((req, res) => {
  ...
  async function main() {
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "	support@relianceexchange.co", // generated ethereal user
